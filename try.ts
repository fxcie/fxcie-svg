import { modifyPath, nodesToPath } from "./src/modifyPath.js";
import { pathToNodes } from "./src/pathToNodes.js";
...
const nodes: PathNode[] = pathToNodes(testPath);
const newPath = modifyPath(testPath, {
	scaleX: 1.2,
	scaleY: 1.2,
	shiftX: 100,
	shiftY: 100,
